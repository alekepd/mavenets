...
def run(attempt_seeds: Tuple[int, ...] = (1234231, 54636, 2931243)) -> None:
    ...
    core_name = "TESTEVAL_mlp_l{}_wdecay{}_learningrate{}_batchsize{}_nepochs{}_baseonly_nulltuner_multiattempt".format(repr(layer_sel), wdecay, lr, batch_size, n_epochs)
