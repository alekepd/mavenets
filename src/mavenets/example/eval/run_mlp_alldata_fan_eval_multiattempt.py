...
def run(attempt_seeds: Tuple= (1234231, 54636, 2931243)) -> None:
    ...
    wdecay = 0.0005
    fan_size = 8
    n_epochs = 600 # this the max number of epochs considered; early stopping is used.
    lr = 1e-4
    record = {}
    ...
    core_name = "TESTEVAL_mlp_l{}_wdecay{}_learningrate{}_alldata_fan{}_multiattempt".format(repr(layer_sel), wdecay, lr, fan_size)
