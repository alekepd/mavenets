...
def run(attempt_seeds: Tuple= (1234231, 54636, 2931243)) -> None:
    ...
    train_dataset, valid_dataset, test_data = get_datasets(device=DEVICE, train_specs=['base_mutsplit_12'], val_specs=['base_mutsplit_12'], feat_type="t5", include_test=True)
    print("Done.")
    ...
    core_name = "TESTEVAL_mlp_t5_l{}_wdecay{}_learningrate{}_nepochs{}_dropout{}_batchsize{}_basemut12only_nulltuner_multiattempt".format(repr(layer_sel), wdecay, lr, n_epochs, dropout, batch_size)
