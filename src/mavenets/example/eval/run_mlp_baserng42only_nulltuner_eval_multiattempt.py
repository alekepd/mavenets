...
Experiments are run on the base_trainval-rng42 split.
...
def test_mlp(
    ...
    train_dataset, valid_dataset = get_datasets(train_specs=['base_trainval-rng42'], val_specs=['base_trainval-rng42'], device=DEVICE, feat_type="onehot")
...
def run(attempt_seeds: Tuple= (1234231, 54636, 2931243)) -> None:
    ...
    core_name = "TESTEVAL_mlp_l{}_wdecay{}_learningrate{}_nepochs{}_baserng42only_nulltuner_multiattempt".format(repr(layer_sel), wdecay, lr, n_epochs)
