"""Evaluate a fixed MLP architecture on test sets.

The model is trained and evaluated on all experimental data sources. No
per-experiment heads are used.
"""
...
def run() -> None:
    ...
    layer_sel =  [8, 256, 32]
    wdecay = 0.0001
    n_epochs = 70 # Model is trained for this many epochs, early stopping is imperfect here.
    lr = 1e-4
    ...
    core_name = "TESTEVAL_mlp_l{}_wdecay{}_learningrate{}_alldata_nepoch{}".format(repr(layer_sel), wdecay, lr, n_epochs)
