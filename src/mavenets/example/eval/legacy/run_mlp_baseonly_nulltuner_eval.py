...
def run() -> None:
    ...
    layer_sel =  [16, 32, 16]
    wdecay = 0.0001
    n_epochs = 60  # Model is trained for this many epochs, early stopping is imperfect here.
    lr = 1e-4
    ...
    core_name = "TESTEVAL_mlp_l{}_wdecay{}_learningrate{}_baseonly_nulltuner_nepoch{}".format(repr(layer_sel), wdecay, lr, n_epochs)
