...
def scan(replica: int, total_n_replicas: int) -> None:
    ...
    train_dataset, valid_dataset = get_datasets(device=DEVICE, train_specs=['BA1'], val_specs=['BA1'], feat_type="t5")
    ...
    for layer_sel,wdecay,lr,dropout in tasks:
        name = "mlp_l{}_wdecay{}_lr{}_dropout{}_BA1_nulltuner.csv".format(repr(layer_sel), wdecay, lr, dropout)
