...
The model is trained on the 'base_trainval-rng596' dataset only.
...
def test_mlp(
    ...
    train_dataset, valid_dataset = get_datasets(train_specs=['base_trainval-rng596'], val_specs=['base_trainval-rng596'], device='cuda', feat_type="onehot")
