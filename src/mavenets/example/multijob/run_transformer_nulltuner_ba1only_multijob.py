...
def test_transformer(
    ...
    train_dataset, valid_dataset = get_datasets(train_specs=['BA1'], val_specs=['BA1'], device=DEVICE)
...
def scan(replica: int, total_n_replicas: int) -> None:
    ...
    for (n_blocks,
        ...
        name = "b{}_h{}_e{}_wdecay{}_mlpdrop{}_mhadrop{}_flayers{}_fdrop{}_ba1only.csv".format(
            n_blocks,
            n_heads,
            emb_size,
            weight_decay,
