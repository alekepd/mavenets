...
The model is trained on the 'base_trainval-rng42' dataset only.
...
def test_mlp(
    ...
    train_dataset, valid_dataset = get_datasets(train_specs=['base_trainval-rng42'], val_specs=['base_trainval-rng42'], device='cuda', feat_type="onehot")
