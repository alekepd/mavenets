...
The model is trained on the 'base_dedup' dataset only.
...
def test_mlp(
    ...
    train_dataset, valid_dataset = get_datasets(train_specs=['base_dedup'], val_specs=['base_dedup'], device='cuda', feat_type="onehot")
